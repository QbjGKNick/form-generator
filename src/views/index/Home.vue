  ...
  <div class="container">
    ...
    <div class="center-board">
      <div class="action-bar">
        <c-button icon="el-icon-video-play" type="text" @click="run">
          运行
        </c-button>
        <c-button icon="el-icon-view" type="text" @click="showJson">
          查看json
        </c-button>
        <c-button icon="el-icon-download" type="text" @click="download">
          导出vue文件
        </c-button>
        <c-button
          class="copy-btn-main"
      ...
      <c-scrollbar class="center-scrollbar">
        <c-row class="center-board-row" :gutter="formConf.gutter">
          <c-form
            :size="formConf.size"
    ...
    <code-type-dialog
      ...
      @confirm="generate"
    />
    <c-input id="copyNode" type="hidden" />
  </div>
</template>
