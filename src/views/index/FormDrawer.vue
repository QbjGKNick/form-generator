  ...
  <div>
    ...
    >
      <div style="height:100%">
        <c-row style="height:100%;overflow:auto">
          <c-col :md="24" :lg="12" class="left-editor">
            <div class="setting" title="资源引用" @click="showResource">
              <c-badge :is-dot="!!resources.length" class="item">
                <i class="el-icon-setting"></i>
              </c-badge>
            </div>
            <c-tabs v-model="activeTab" type="card" class="editor-tabs">
              <c-tab-pane name="html">
                <span slot="label">
          ...
          <c-col :md="24" :lg="12" class="right-preview">
